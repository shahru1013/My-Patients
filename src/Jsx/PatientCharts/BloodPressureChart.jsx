...
export default function BloodPressureChart({val}) {
  const labels = val?.levels //['12-10-2022', '01-03-2023', '04-06-2023', '11-07-2023', '17-08-2023', '11-10-2023', '12-01-2022'];
  const pressureUpper = val?.pressureUpper//[110, 125, 106, 127, 110, 109, 116];
  const pressureLower = val?.pressureLower //[80, 85, 76, 83, 85, 82, 80];
  const data = {
    labels,
    datasets: [
      {
